...
if (counter == 12)
  ...
  if (counter == 14)
  {
    image(airplane8,10,10);
    if (inp.value() == "Boeing767")
    {
      startTime = frameCount;
      counter++;
    }
